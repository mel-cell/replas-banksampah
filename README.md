...
[![Frontend Progress](https://img.shields.io/badge/Frontend-85%25-green.svg)](https://github.com/your-repo/replas)
[![Backend Progress](https://img.shields.io/badge/Backend-75%25-yellow.svg)](https://github.com/your-repo/replas)
...
#### 👤 User Dashboard (NEW)
- **Profile Page**: User information and wallet balance
- **Scan QR**: Camera integration for machine activation
- **Cara Penggunaan**: Comprehensive usage guide with step-by-step instructions
- **Transaction History**: Points earning and redemption history
- **Responsive Layout**: Sidebar navigation with active states
